...
const SocialLinks = () => (
  <Box variant="layout.verticalAlign" mt={4} sx={{ fontSize: 5 }}>
    <RouterLink
      to="https://github.com/reserve-protocol/reservations-protocol"
      target="_blank"
    ...
    <Grid columns={[1, 2]} gap={[0, 7]}>
      <Box>
        <Text mt={3} as="p" variant="legend">
          <Trans>
            Welcome to Reservations Protocol - the user interface for registering,
      ...
      <Box>
        ...
        <Text mt={2} as="p" variant="legend">
          <Trans>
            Still have questions? Come talk to the Reservations Protocol community in our
          ...
          <Link
            ...
            target="_blank"
          >
            You can also read the Preserve Protocol Documentation.{' '}
          </Link>
        </Text>
      </Box>
    </Grid>
...
const About = () => (
  <Grid columns={[1, 2]} gap={[4, 7]}>
    <Box>
      <Text variant="title">
        <Trans>The Preserve Project</Trans>
      </Text>
      <Text mt={3} as="p" variant="legend">
        <Trans>
          Preserve aims to help people around the world maintain their spending
      ...
      <Text mt={2} as="p" variant="legend">
        <Trans>
          Reservations Protocol is an open source project developed and maintained by ABC
 ...
 */
const ReservationsProtocolAbout = () => (
  <Box
...
export default ReservationsProtocolAbout
