...
const ListingInfo = (props: BoxProps) => (
  <Box variant="layout.borderBox" p={4} {...props}>
    <InfoBox
      title={t`Reservations Protocol Listing`}
      subtitle={t`Please read more about how Reservations Protocol manages tokens on our repository`}
    />
    <Flex mt={2} mb={3}>
      <SmallButton
        variant="muted"
    ...
    <InfoBox
      mb={3}
      title={t`What is Preserve Governor Alexios?`}
    ...
    <InfoBox
      title={t`Roles`}
      subtitle="Please read more about the different roles in Alexios and the Preserve protocol in the documentation."
    />
  </Box>
)
