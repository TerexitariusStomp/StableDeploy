...
const HelpContent = ({ onClose }: { onClose(): void }) => {
  const items = [
    ...
    },
    {
      ...
      subtitle: t`Understand the Preserve Protocol.`,
      href: PROTOCOL_DOCS,
    },
    {
      title: t`Preserve Forum`,
      subtitle: t`Discussions of ideas and suggestion that the community has on improving the Preserve Ecosystem`,
      href: RESERVE_FORUM,
    },
    {
      title: t`Preserve Discord`,
      subtitle: t`Can’t find what you’re looking for elsewhere or want to join the conversation?`,
      href: DISCORD_INVITE,
    },
    {
      title: t`Preserve Bridge`,
...
const ReservationsProtocolHelp = () => {
...
export default ReservationsProtocolHelp
